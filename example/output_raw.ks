...
// === home.ks ===
// colors.ks is included via manifest utils - no @use needed
...
fn balanceBuilder() {
  return Text(balance.value + " EUR", { fontSize: 32, fontWeight: "bold", color: "white" })
}
